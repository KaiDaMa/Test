...
requirejs(["jquery", "publicTip"], function($, publicTip){
	$(function() {
		...
		if (openCaptcha == "true") {
			$captchaImg.attr("src", '/crossfire/captcha?r=' + Math.random());
			$captchaImg.click(function () {
				$(this).attr("src", '/crossfire/captcha?r=' + Math.random());
			});
		}
		...
		$mobile.blur(function () {
			var mobile = $(this).val();
			if (mobile.trim() == '') {
				publicTip.showTipForStr("Cellphone number is required");
		...
		$password.blur(function () {
			...
			if (password.trim() == '') {
				publicTip.showTipForStr("Password is required");
		...
		if (openCaptcha == "true") {
			$captcha.blur(function () {
				...
				$.ajax({
					type: 'post',
					dataType: 'json',
					url: '/crossfire/api/checkCaptcha',
